...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-black/30 motion-safe:duration-100 supports-backdrop-filter:backdrop-blur-sm motion-safe:data-open:animate-in motion-safe:data-open:fade-in-0 motion-safe:data-closed:animate-out motion-safe:data-closed:fade-out-0',
        className,
      )}
      {...props}
    />
